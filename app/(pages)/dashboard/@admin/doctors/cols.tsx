...
export const cols: ColsType<ColumnKey, DoctorWithStats> = [
  {
    columnKey: "name_en",
    header: "Doctor",
    accessorKey: "name_en",
    ...
    cell: (item) => (
      <div className="flex items-center gap-2">
        ...
        <div className="">
          ...
          <p className="text-muted-foreground normal-case">{item.email}</p>
        </div>
      </div>
    ),
  },
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-5">
          <div className="text-status-completed flex flex-col items-center text-xs">
            <span className="">{props.today_appointments_count.completed}</span>
            <span>comp.</span>
          </div>
          ...
          <div className="text-status-rejected flex flex-col items-center text-xs">
            <span className="">{props.today_appointments_count.rejected}</span>
            <span>rej.</span>
          </div>
        </div>
      </div>
    ...
    cell: ({ id }) => (
      <div className="flex gap-2">
        <Link
          ...
          className="border-border bg-secondary hover:bg-muted hover:text-foreground dark:hover:bg-input/30 flex size-9 items-center justify-center rounded-lg border dark:bg-transparent"
        >
          <Eye size={16} />
        </Link>
